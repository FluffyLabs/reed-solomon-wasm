...
*/
export function encode(recovery_count: number, shard_bytes: number, shards: ShardsCollection): ShardsCollection;
/**
...
* @returns {ShardsCollection}
*/
export function decode(original_count: number, recovery_count: number, shard_bytes: number, shards: ShardsCollection): ShardsCollection;
/**
