...
* @param {number} shard_bytes
* @param {ShardsCollection} shards
* @returns {ShardsCollection}
*/
module.exports.encode = function(recovery_count, shard_bytes, shards) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(shards, ShardsCollection);
        var ptr0 = shards.__destroy_into_raw();
        wasm.encode(retptr, recovery_count, shard_bytes, ptr0);
...
* @returns {ShardsCollection}
*/
module.exports.decode = function(original_count, recovery_count, shard_bytes, shards) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(shards, ShardsCollection);
        var ptr0 = shards.__destroy_into_raw();
        wasm.decode(retptr, original_count, recovery_count, shard_bytes, ptr0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
module.exports.ShardsCollection = ShardsCollection;
...
module.exports.__wbg_newwithbyteoffsetandlength_bd3d5191e8925067 = function(arg0, arg1, arg2) {
    const ret = new Uint16Array(getObject(arg0), arg1 >>> 0, arg2 >>> 0);
    return addHeapObject(ret);
};

module.exports.__wbg_new_51798470384ee5a8 = function(arg0) {
...
module.exports.__wbg_length_ff22981e43417ccf = function(arg0) {
    const ret = getObject(arg0).length;
    return ret;
};
...
module.exports.__wbg_set_e83c20bbf4b38a6b = function(arg0, arg1, arg2) {
    getObject(arg0).set(getObject(arg1), arg2 >>> 0);
};
...
const path = require('path').join(__dirname, 'reed_solomon_wasm_bg.wasm');
